...
parser.add_argument('--data_root', type=str,default=r'D:\data\animals_catalogy\salicon',
...
parser.add_argument('--output', type=str,default=r'D:\data\animals_catalogy\salicon\out',
